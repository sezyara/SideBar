...
public class Common {
	...
	public static final String EXTRA_XHALO_SNAP_SIDE = PKG_XHALOFLOATINGWINDOW
			+ ".EXTRA_SNAP_SIDE";
	...
	public static final int PREF_DEF_LABEL_SIZE = 10;
	...
	public static final int PREF_DEF_ANIM_TIME = 150;
