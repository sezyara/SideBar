package ru.sezex.sidebar.preference;
...
public class SeekBarDialog extends DialogPreference implements
	...
	public SeekBarDialog(Context context, AttributeSet attrs) {
		...
		mDefault = Integer.parseInt(attrs.getAttributeValue(null,
				"defaultValue"));
